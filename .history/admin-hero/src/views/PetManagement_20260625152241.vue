...
.pet-management .el-card__header {
  background: linear-gradient(90deg, #4a2c0f, #7a521d);
  color: #ffd700;
  font-size: 20px;
  font-weight: bold;
...
.pet-management .el-table th {
  background: #2d1f0d !important;
  color: #ffd700 !important;
  font-weight: bold;
  text-align: center;
}

.pet-management .el-table tr {
...
.pet-management .el-button--success {
  background: linear-gradient(135deg, #1e8f3f, #2ecc71);
  border: none;
}

.pet-management .el-button--primary {
  background: linear-gradient(135deg, #1f5fff, #4f8cff);
  border: none;
}
