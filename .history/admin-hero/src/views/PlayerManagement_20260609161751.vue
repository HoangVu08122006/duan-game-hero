  ...
  <div v-if="selectedPlayer.pets && selectedPlayer.pets.length > 0">
    <div v-for="pet in selectedPlayer.pets" :key="pet.id" class="pet-card">
      <div class="pet-info-main">
        ...
        <div class="admin-control" style="margin-top: 10px; padding: 10px; border: 1px dashed #dcdfe6; border-radius: 4px;">
           <span style="font-size: 12px; margin-right: 5px;">Sửa cấp:</span>
           <el-input-number 
             v-model="pet.edit_level" 
             size="small" 
             :min="1" 
             :max="999" 
