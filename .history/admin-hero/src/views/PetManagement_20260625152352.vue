...
.pet-management .el-button--success {
  background: linear-gradient(#b58b46, #7d5827);
  border: 1px solid #5a3917;
  color: #fff8dc;
}

/* Nút sửa */
.pet-management .el-button--primary {
  background: linear-gradient(#5b88b8, #345a83);
  border: 1px solid #1f3d5d;
}

/* Nút chi tiết */
.pet-management .el-button--danger {
  background: linear-gradient(#a85a40, #6d311d);
  border: 1px solid #4d1e11;
}
...
/* Dialog */
.el-dialog {
  border: 4px solid #6b4f2a !important;
