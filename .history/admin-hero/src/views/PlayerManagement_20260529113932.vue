<template>
  ...
  <el-descriptions :column="3" border size="small">
    ...
    <el-descriptions-item label="Cấp Sát Thương CM">💥 Lv. {{ selectedPlayer.upgraded_crit_damage_lv }}</el-descriptions-item>
            ...
            <h4 class="sub-section-title">🛠️ ĐIỀU CHỈNH CHỈ SỐ NGƯỜI CHƠI</h4>
<div class="stats-edit-box" style="margin-bottom: 20px;">
  <el-form :model="statsBasicForm" inline size="small">
    <el-form-item label="Vàng:"><el-input-number v-model="statsBasicForm.gold" /></el-form-item>
    <el-form-item label="EXP:"><el-input-number v-model="statsBasicForm.exp" /></el-form-item>
    <el-form-item label="Cấp độ:"><el-input-number v-model="statsBasicForm.level" /></el-form-item>
    <el-form-item label="Ải H.Tại:"><el-input-number v-model="statsBasicForm.current_floor" /></el-form-item>
    <el-form-item label="Ải Cao Nhất:"><el-input-number v-model="statsBasicForm.highest_floor" /></el-form-item>
