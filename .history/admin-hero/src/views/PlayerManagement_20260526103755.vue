        ...
        <el-tabs type="border-card" class="detail-tabs">
          <el-tab-pane label="📊 Thông Số & Công Pháp">
            <el-descriptions :column="3" border size="small">
              ...
              <el-descriptions-item label="Máu Hiện Tại" content-class-name="hp-text">❤️ {{ formatNumber(selectedPlayer.current_hp) }}</el-descriptions-item>
              <el-descriptions-item label="Cấp HP">💪 {{ selectedPlayer.upgraded_hp_lv }}</el-descriptions-item>
              ...
              <el-descriptions-item label="Cấp Công">⚔️ {{ selectedPlayer.upgraded_attack_lv }}</el-descriptions-item>
              ...
              <el-descriptions-item label="Cấp Tốc Độ">⚡ {{ selectedPlayer.upgraded_speed_lv }}</el-descriptions-item>

              <el-descriptions-item label="Tỉ Lệ CM (Base/Cur)">🎯 {{ selectedPlayer.base_crit_rate }}% / {{ selectedPlayer.current_crit_rate }}%</el-descriptions-item>
              <el-descriptions-item label="Sát Thương CM (Base/Cur)">💥 {{ selectedPlayer.base_crit_damage }}% / {{ selectedPlayer.current_crit_damage }}%</el-descriptions-item>
              <el-descriptions-item label="Cấp Chí Mạng">🎯 {{ selectedPlayer.upgraded_crit_rate_lv }}</el-descriptions-item>
            </el-descriptions>
