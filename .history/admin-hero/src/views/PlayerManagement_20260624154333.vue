...
<div style="margin-top: 20px; display: flex; justify-content: center;">
  ...
  <el-descriptions :column="3" border size="small">
    ...
    <el-descriptions-item label="Cấp Sát Thương CM">💥 Lv. {{ selectedPlayer.upgraded_crit_damage_lv }}</el-descriptions-item>
         ...
         <div v-for="pet in selectedPlayer.pets" :key="pet.pivot.id" class="pet-card">
  <div class="pet-info-main">
    ...
    <div class="admin-control" style="margin-top: 10px; padding: 10px; border: 1px dashed #e6a23c; border-radius: 4px;">
      ...
      <el-button type="warning" size="small" @click="handleAdminUpgradePet(pet)">
        Áp dụng
      </el-button>
    ...
    <div class="pet-power">
        Lực chiến Pet: ⚡ {{ formatNumber(pet.calculated_stats?.total_power || 0) }}
    </div>
  </div>
