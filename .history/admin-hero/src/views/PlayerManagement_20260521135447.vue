...
// 🛠️ THÊM MỚI: Biến lưu trữ dữ liệu từ API tổng lực chiến
...
const fetchPlayerDetail = async (playerId) => {
  ...
  powerDetails.value = null // reset dữ liệu cũ
  
  try {
    // Sử dụng Promise.all để gọi đồng thời 2 API giúp tối ưu thời gian phản hồi
...
/* CSS Khối chi tiết lực chiến mới */
