<template>
  ...
  <el-dialog v-model="dialogVisible" :title="isEdit ? 'Chỉnh sửa Pet' : 'Thêm Pet mới'" width="600px">
    <el-form :model="editForm" label-width="140px">
      </el-form>
    <template #footer>
      <el-button @click="dialogVisible = false">Hủy</el-button>
      <el-button type="primary" @click="savePet" :loading="submitLoading">Xác nhận</el-button>
    </template>
  </el-dialog>
