  ...
  <div class="management-container">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="subtitle">Xem danh sách, kiểm tra chi tiết, Pet và thông số Game Master</p>
      </div>
      <div class="action-buttons">
        <el-input 
          ...
          clearable 
        />
        <button class="btn-add" @click="openRegisterDialog">➕ Tạo Mới</button>
        <el-button type="primary" :loading="loading" @click="fetchPlayers" round>🔄</el-button>
      </div>
    </div>

    <el-card shadow="never" class="table-card">
      <el-table v-loading="loading" :data="pagedPlayers" border stripe style="width: 100%">
