...
use App\Http\Controllers\Api\GachaAdminController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //history gacha
    Route::get('/gacha/history', [GachaController::class, 'history']);
});
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/pets/equip', [PetController::class, 'equip']);
...
Route::post('/pets', [AdminPetController::class, 'store']);
Route::get('/pets/{id}', [AdminPetController::class, 'show']);
Route::put('/pets/{id}', [AdminPetController::class, 'update_pet']);
Route::get('/pets/{id}/logs', [AdminPetController::class, 'getPetLogs']);
Route::post('/pets/equip', [AdminPetController::class, 'adminEquipPet']);
...
// Nhóm các route quản lý cấu hình Gacha
Route::prefix('admin')->group(function () {
    Route::get('/gacha', [GachaAdminController::class, 'index']);      // Xem danh sách
    Route::post('/gacha', [GachaAdminController::class, 'store']);     // Thêm
    Route::put('/gacha/{id}', [GachaAdminController::class, 'update']); // Sửa
    Route::delete('/gacha/{id}', [GachaAdminController::class, 'destroy']); // Xóa
    Route::get('/gacha/logs', [GachaAdminController::class, 'getLogs']); // log

    //khóa tk
    Route::post('/players/{id}/ban', [PlayerStatusController::class, 'ban']);
    //Khôi phục tk
Route::post('/players/{id}/unban', [PlayerStatusController::class, 'unban']);
});
