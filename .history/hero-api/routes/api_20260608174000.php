...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/admin/weapon/set-level', [WeaponController::class, 'adminUpdateWeaponLevel']);

    // API trang bị vũ khí
    // Route::post('/weapon/equip', [WeaponController::class, 'equip']); //cũ
    Route::middleware('auth:sanctum')->post('/weapon/equip', [WeaponController::class, 'equip']); // mới
    // admin
    Route::middleware(['auth:sanctum', 'is_admin'])->post('/admin/weapon/equip', [WeaponController::class, 'equip']);
});
