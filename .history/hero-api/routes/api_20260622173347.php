...
Route::prefix('admin')->group(function () {
    ...
    Route::delete('/entity/delete-draft/{id}', [AdminEntityController::class, 'deleteDraft']);
    Route::get('/entity/logs', [AdminEntityController::class, 'getLogs']);
});
...
Route::prefix('admin')->group(function () {
    Route::get('/', [GachaAdminController::class, 'index']);      // Xem danh sách
    Route::post('/', [GachaAdminController::class, 'store']);     // Thêm
    Route::put('/{id}', [GachaAdminController::class, 'update']); // Sửa
    Route::delete('/{id}', [GachaAdminController::class, 'destroy']); // Xóa
    Route::get('/logs', [GachaAdminController::class, 'getLogs']); // log
});
