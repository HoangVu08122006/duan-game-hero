...
//xem name và pass và sauwr
Route::get('/list/players/{id}/account', [PlayerController::class, 'getPlayerAccountForAdmin']);
Route::put('/list/players/{id}/account', [PlayerController::class, 'updatePlayerAccountByAdmin']);