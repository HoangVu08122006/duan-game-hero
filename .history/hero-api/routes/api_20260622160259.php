...
use App\Http\Controllers\Api\GachaConfigController;
...
Route::middleware('auth:sanctum')->prefix('admin/gacha-config')->group(function () {
    Route::get('/', [GachaConfigController::class, 'index']);      // Xem danh sách
    Route::post('/', [GachaConfigController::class, 'store']);     // Thêm
    Route::put('/{id}', [GachaConfigController::class, 'update']); // Sửa
    Route::delete('/{id}', [GachaConfigController::class, 'destroy']); // Xóa
    Route::get('/logs', [GachaConfigController::class, 'getLogs']); // Thêm dòng này
});
