...
Route::prefix('admin/rewards')->group(function () {
    Route::get('/', [AdminRewardController::class, 'index']);      // Xem danh sách
    Route::post('/store', [AdminRewardController::class, 'store']); // Thêm mới
    Route::put('/{dayIndex}', [AdminRewardController::class, 'update']); // Sửa
    Route::delete('/{dayIndex}', [AdminRewardController::class, 'destroy']); // Xóa
});

Route::prefix('admin')->group(function () {
    // Lấy danh sách các gói cấu hình
    Route::get('/configs', [AdminConfigController::class, 'index']);
    // Tạo mới gói cấu hình (kèm item)
