...
Route::middleware(['auth:sanctum'])->prefix('admin')->group(function () {
    // Sửa route để khớp với gọi API trong Vue (/api/admin/entity/monster)
    Route::get('/entity/monster', [AdminEntityController::class, 'indexMonster']);
    Route::get('/entity/boss', [AdminEntityController::class, 'indexBoss']);
