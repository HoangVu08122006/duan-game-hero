...
//quản lý vũ khí
Route::get('/weapons', [WeaponController::class, 'index_weapon']);
Route::get('/weapons/{id}', [WeaponController::class, 'show_weapon']);
Route::post('/weapons', [WeaponController::class, 'store_weapon']);
Route::put('/weapons/{id}', [WeaponController::class, 'update_weapon']);
Route::delete('/weapons/{id}', [WeaponController::class, 'destroy_weapon']);