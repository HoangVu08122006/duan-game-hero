...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('is_admin')->group(function () {
        Route::post('/admin/weapon/upgrade', [AdminWeaponController::class, 'adminUpgrade']); // <--- Đặt ở đây
...
//admin chỉnh sửa cấp độ pet
Route::middleware(['auth:sanctum', 'is_admin'])->group(function () {
    Route::post('/admin/pet/upgrade', [AdminPetController::class, 'adminUpgradePet']);
});
