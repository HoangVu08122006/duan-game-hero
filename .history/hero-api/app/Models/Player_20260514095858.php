...
protected static function booted()
{
    ...
    // 1. Chạy khi MỚI TẠO nhân vật (Chỉ chạy 1 lần duy nhất)
    static::created(function ($player) {
        ...
        // Mới tạo lv 1 nên thường chưa cần checkUnlock, nhưng để đây cũng không sao
        $player->checkAndUnlockWeapon();
    });

    // 2. Chạy MỖI KHI Hero có thay đổi dữ liệu (ví dụ: cộng thêm EXP, tăng Level)
    static::saving(function ($player) {
        // Logic tính EXP/Level cũ của bạn
        ...
        // QUAN TRỌNG: Phải gọi hàm này ở đây để khi level nhảy lên 100 
        // nó sẽ tự quét và thêm Kiếm Sắt vào bảng player_weapons
        $player->checkAndUnlockWeapon();
    });
}
