  ...
  public function adminUpdatePetLevel(Request $request)
    {
        ...
        // Load kèm model 'pet' để có dữ liệu tính toán (base_dps)
        ...
        if (!$playerPet) {
            return response()->json(['status' => 'error', 'message' => 'Không tìm thấy pet'], 404);
        }
        ...
        // TÍNH TOÁN LẠI CHỈ SỐ MỚI
        $newStats = $this->calculatePetStats($playerPet);
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'new_stats' => $newStats // Trả về chỉ số đã tính toán
            ]
        ]);
    }
