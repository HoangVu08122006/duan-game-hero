...
public function addExp(Request $request) {
    ...
    // 1. Cộng dồn EXP nhận được
    $player->exp += $request->exp;

    // 2. Lưu vào Database. 
    // Lệnh save() này sẽ kích hoạt logic 'static::saving' trong Model Player.php
    // giúp Hero tự động lên cấp, trừ EXP dư và check mở khóa vũ khí.
    $player->save();
