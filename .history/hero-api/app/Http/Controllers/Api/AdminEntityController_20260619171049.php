...
class AdminEntityController extends Controller
{
    ...
    private function logAction(string $action, string $type, ?int $entityId, string $description, ?array $payload = null)
{
    \App\Models\MonsterLog::create([
        ...
        'payload'     => $payload ? json_encode($payload) : null, // Lưu JSON nếu có
