...
class GachaGachaAdminController extends Controller
{
    ...
    // Xem lịch sử thay đổi cấu hình Gacha của Admin
    public function getLogs()
    {
        // Lấy tất cả log, sắp xếp theo thời gian mới nhất lên đầu
        $logs = DB::table('admin_gacha_logs')
