...
public function updatePlayerStats(Request $request, $id)
{
    ...
    // 1. Tính toán giá trị "gốc" (Reverse Engineering) từ giá trị hiện tại trong DB
    // Vì công thức cũ là: base = base_gốc * (1.08 ^ lv)
    // Nên: base_gốc = base_hiện_tại / (1.08 ^ lv_hiện_tại)
