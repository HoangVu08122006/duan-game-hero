...
public function equip(Request $request)
{
    ...
    // 1. Tìm vũ khí TRƯỚC KHI thực hiện bất kỳ thay đổi nào
    ...
    // 2. Kiểm tra level TRƯỚC KHI thay đổi
    if ($player->level < $targetWeapon->weapon->required_hero_level) {
        return response()->json(['message' => 'Bạn chưa đủ level!'], 403);
    }

    // 3. Nếu mọi thứ OK, mới tiến hành thay đổi trong Transaction
    ...
    return response()->json([
        'status' => 'success',
        'message' => 'Trang bị thành công: ' . $targetWeapon->weapon->name,
