...
public function index(): JsonResponse
    ...
    public function update_(Request $request, $id): JsonResponse
{
    $pet = Pet::find($id);
    if (!$pet) {
    ...
    $validated = $request->validate([
        ...
        'skill_1_name' => 'nullable|string',
        'skill_2_name' => 'nullable|string',
        'skill_3_name' => 'nullable|string',
        'skill_1_description' => 'nullable|string',
        'skill_2_description' => 'nullable|string',
        'skill_3_description' => 'nullable|string',
    ]);
