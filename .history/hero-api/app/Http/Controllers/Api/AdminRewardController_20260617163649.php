...
class AdminRewardController extends Controller
{
    ...
    {
        return Reward::orderBy('day_index', 'asc')->get();
    }
    ...
    public function activate($id)
    {
        return DB::transaction(function () use ($id) {
            ...
            // 2. Kích hoạt gói mới
            $newConfig = RewardConfig::findOrFail($id);
            $newConfig->update(['status' => 'active', 'activated_at' => now()]);
