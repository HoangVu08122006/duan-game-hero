...
public function index_weapon() {
    ...
    public function store(Request $request) {
        ...
        return response()->json(['message' => 'Tạo thành công', 'data' => new WeaponResource($weapon)], 201);
    }

    public function update(Request $request, $id) {
        $weapon = Weapon::findOrFail($id);
        $weapon->update($request->all());
        return response()->json(['message' => 'Cập nhật thành công', 'data' => new WeaponResource($weapon)]);
    }
