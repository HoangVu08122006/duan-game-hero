...
// API ĐĂNG XUẤT
    ...
    {
        // Xóa token hiện tại của người chơi để họ không dùng lại được nữa
...
{
    // Trả về player đang sở hữu Token kèm theo vũ khí và pet
    return response()->json([
        'player' => $request->user()->load(['weapons', 'pet'])
    ]);
}
}