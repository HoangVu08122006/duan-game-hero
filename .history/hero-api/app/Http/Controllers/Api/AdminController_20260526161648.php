...
public function store_weapon(Request $request) {
    try {
        // 1. Validate toàn bộ dữ liệu (bao gồm cả ảnh)
        ...
        return DB::transaction(function () use ($data) {
            // Dùng $data (đã có đường dẫn ảnh) để tạo vũ khí
            $weapon = Weapon::create($data);

            // Gán vũ khí cho người chơi
            $players = Player::all();
        ...
        Log::error('Lỗi store_weapon: ' . $e->getMessage());
