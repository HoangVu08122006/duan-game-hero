   ...
   public function getPlayerDetail($id)
{
    ...
    foreach ($player->playerPets as $playerPet) {

        $stats = $this->calculatePetStats($playerPet);

        $playerPet->calculated_stats = $stats;

        $playerPet->skill_1_dame = $stats['skill_1_dame'];
        $playerPet->skill_2_dame = $stats['skill_2_dame'];
        $playerPet->skill_3_dame = $stats['skill_3_dame'];
    }
